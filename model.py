...
class DoubleConv(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # sequential is a container for the modules
        # output of the first module is the input of the second modulee etc.
